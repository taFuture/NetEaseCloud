...
import { Popup,Area,Button,DatetimePicker,Circle,NoticeBar,Tab,Tabs,Tabbar,TabbarItem,Collapse,CollapseItem,ShareSheet} from 'vant';
...
Vue.use(Tabbar).use(TabbarItem).use(Collapse).use(CollapseItem).use(ShareSheet)
Vue.use(Player)
